...
#ifndef PokemonAutomation_PokemonSwSh_EggAutonomousKeep_H
#define PokemonAutomation_PokemonSwSh_EggAutonomousKeep_H
...
class EggAutonomousKeep_Descriptor : public SingleSwitchProgramDescriptor{
public:
    EggAutonomousKeep_Descriptor();
    class Stats;
...
class EggAutonomousKeep : public SingleSwitchProgramInstance{
public:
    EggAutonomousKeep();
